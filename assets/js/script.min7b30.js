...
app.controller('myCtrl', async function($scope) {
                $scope.init = function() {
                        ...
                        $scope.chain = "Ethereum", $scope.addressdex = "0x07b95EAdcf61eeD925b983e76E49d86eEfAd963e", $scope.scan = "https://etherscan.io/", $scope.idscan = "Etherscan", $scope.erc20 = {
                            name: '',
                            symbol: '',
                            network: !isBnb
                        };
